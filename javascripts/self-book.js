...
$(function() {
  ...
  $(".article-content").click(function() {
    if (travelTitle[0]!=undefined && $(this).index()==0){
      ...
      while (travelBookmark[travelMark]!=undefined){
        $("#append_mark").append('<div class="left-bookmark" value='+travelBookmark[travelMark]+'>'+travelBookmark_lan[travelMark]+'</div>');
        travelMark++;
      }
      var bookmark = "all";
    ...
    if (selfTitle[0]!=undefined && $(this).index()==2){
      ...
      var selfMark = 0;
      $("#append_mark").html('<div class="left-bookmark active" value="all">全部</div>');
      while (selfBookmark[selfMark]!=undefined){
        $("#append_mark").append('<div class="left-bookmark" value='+selfBookmark[selfMark]+'>'+selfBookmark_lan[selfMark]+'</div>');
        selfMark++;
      }
      var bookmark = "all";
      $(".left-bookmark").unbind('click').on("click", function(event) {
